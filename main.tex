...
When the model is using the Popes's approximation, the total catch of stock ($C^s_{y,a}$) is calculated as a function of $C_{tmp}^{k_s}_a$ for each stock $s$ ($1\leq s \leq nstk$) at age $a$ in the year $y$ ($y_0 \leq y \leq y_N$): 
